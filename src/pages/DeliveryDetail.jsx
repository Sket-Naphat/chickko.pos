            ...
            try {
                ...
                if (ordersResponse.data?.success && ordersResponse.data?.data) {
                    const apiOrders = ordersResponse.data.data.map(order => ({
                        ...
                        totalPrice: order.totalGrabPrice, // ✅ ใช้ totalGrabPrice จาก API
                        items: order.orderDetails?.map(detail => ({
                            name: detail.menuName,
                            qty: detail.quantity,
                            price: detail.grabPrice / detail.quantity, // ✅ คำนวณราคาต่อชิ้น
                ...
                <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-base-content/70">
                            วันที่ {formatDate(deliveryData.saleDate)}
                        </p>
                    </div>
                </div>
